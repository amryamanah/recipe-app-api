...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short(self):
        """Test that the password myst be more than 5 char"""
        payload = {
            'email': "test@nectico.com",
            "password": 'pwd',
            'name': 'Test name'
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email="test@nectico.com", password="testpass")
        payload = {
            'email': "test@nectico.com",
            "password": 'wrong',
            'name': 'Test name'
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test that post that is not allowed on ME_URL"""
